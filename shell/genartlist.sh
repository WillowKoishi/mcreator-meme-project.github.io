...
<head>
    ...
    <meta name="description" content="收集一些MCreator梗">
    <link rel="icon" href="/static/favicon.ico">
    <title>MCreator Meme Project | 收集一些MCreator梗</title>
...
<body>
    <main class="container">
        <h1>MCreator Meme Project | <a href="/">图片梗</a></h1>
        <h5 id="description"></h5>
        <article id="view">
            <github-md>
> 这里收集了一些 MCreator 相关的文字梗。
...
cat >> "text/index.html" <<EOF
        ...
        <footer id="footer">
            <p>通过Pull Requests增加我们的Meme!</p>
            <p><a href="https://github.com/MCreator-Meme-Project/mcreator-meme-project.github.io" title="仓库地址">❤点❤击❤即❤玩❤</a></p>
        </footer>
    </main>
</body>
